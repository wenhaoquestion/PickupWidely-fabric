...
## [2.0.1+1.18.2] — 2026-08-26

Maintenance release for Minecraft 1.18.2.
...
## [2.0.0+1.18.2] — 2026-08-26

- Ported the complete 2.0 feature set to Fabric for Minecraft 1.18.2 and Java 17.
- Added legacy Fabric channel-buffer networking and command-v1 registration.
- Adapted the settings screen, key binding, and XP attraction mixin to 1.18.2 APIs.
...
- Java 17 target retained for the Minecraft 1.18.2 port
