...
## [2.0.1+1.17.1] — 2026-08-26

Maintenance release for Minecraft 1.17.1.
...
### Added
- **Minecraft 1.17.1 port** — built against Yarn `1.17.1+build.65` and the legacy Fabric networking APIs
...
- Java 16 target (required for Minecraft 1.17.1)
