...
Requires **Minecraft 1.17.1**, **Fabric Loader ≥ 0.15.11**, **Fabric API**, and **Java 16**.
...
Requirements: JDK 16, internet connection (first build downloads Minecraft assets).
